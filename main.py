    ...
    if request.method == 'POST':
        ...
        for result in flight_results:
            for flight in result:
                ...
                result[flight]['departure_time'] = str(departure_minutes // 60) + ":" + str(departure_minutes % 60)
                arrival_minutes = result[flight]['arrival_time'] * 5
                result[flight]['arrival_time'] = str(arrival_minutes // 60) + ":" + str(arrival_minutes % 60)
